...
if(isset($_POST["submit"]))
{
  ...
  if ($stu_pass == $re_password) 
  {
    $sql = "INSERT INTO student (stu_matric_id, stu_pass )
    VALUES ('".$_POST["stu_matric_id"]."','".$_POST["stu_pass"]."')";
...
<html>
<head>
  <title>Create Profile Student</title>
  <style>
...
<body>
  ...
  <div class="container">
    ...
    <form class="form-horizontal" action="" method="post">
      ...
      <input type="text" id="name" name="stu_matric_id">

      <label for="email">Password</label>
      <input type="text" id="pass" name="stu_pass">

      <label for="phone">Retype Password</label>
      <input type="text" id="re_pass" name="re_password">
