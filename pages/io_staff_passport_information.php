...
<html>
<head>
  <title>IO Passport Information</title>
  <style>
...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
        <label for="email">2nd Passport Number</label>
        <h7> </h7>
      </div>
      <br>

      <div class="row">
        <label for="email">2nd Passport Expiry Date</label>
        <h7> </h7>
      </div>
      <br>
      ...
      <div class="row">
        <label for="email">3rd Passport Number</label>
        <h7> </h7>
      </div>
      <br>

      <div class="row">
        <label for="email">3rd Passport Expiry Date</label>
        <h7> </h7>
      </div>
      <br>
  ...
  <div class="container">
    ...
    <button type="" class="btn btn-primary" name="Passport Information">
        <a href="io_staff_passport_information_edit.php">Update Information </a>
    </button>
  </div>
