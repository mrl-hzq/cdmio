...
<html>
<head>
  <title>IO Programme Information</title>
  <style>
...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
        <label for="phone">Duraration Of Study</label>
        <h7> </h7>
      </div>
      <br>
      ...
      <div class="row">
        <label for="phone">Miissbehaviour Date Start</label>
        <h7> </h7>
      </div>
      <br>
  ...
  <div class="container">
    ...
    <button type="" class="btn btn-primary" name="Passport Information">
        <a href="io_staff_programme_information_edit.php">Update Information </a>
    </button>
  </div>
