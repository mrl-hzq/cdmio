...
<html>
<head>
  <title>IO Edit Supervisor Information</title>
  <style>
...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
        <label for="phone">Supervisor Type</label>
        <input type="text" id="" name="">
        <h7> </h7>
      </div>
      <br>
  ...
  <div class="container" align="center">
    ...
    <button type="" class="btn btn-primary" name="">
        <a href="io_staff_supervisor_information.php">Back</a>
    </button>

    <button type="" class="btn btn-primary" name="">
        <a href="io_staff_supervisor_information.php">Save Changes</a>
    </button>
  </div>
